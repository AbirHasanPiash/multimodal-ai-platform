...
Revision ID: 425f84f2aff7
Revises: 
Create Date: 2026-01-31 20:49:14.485609
...
def upgrade() -> None:
    ...
    sa.Column('currency', sa.String(), nullable=True),
    sa.Column('credits_added', sa.Numeric(precision=18, scale=6), nullable=False),
    sa.Column('status', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
